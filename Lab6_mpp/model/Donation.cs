...
namespace Lab6_mpp.model
{
    public class Donation : Identifiable<long>
    {
        ...
        public long IDCase { get => idCase; set => idCase = value; }
        public string DonorFirstame { get => donorFirstName; set => donorFirstName = value; }

        public string PhoneNumber { get => phoneNumber; set => phoneNumber = value; }

        public float AmountDonated { get => amountDonated; set => amountDonated = value; }

        public string DonorAddress { get => donorAddress; set => donorAddress = value; }
        public long ID { get; set; }

        public string DonorLastName { get => donorLastName; set => donorLastName = value; }
