...
namespace Lab6_mpp.repository
{
    public class VolunteerDbRepository : IRepository<Volunteer, long>
    {
        ...
        public void Add(Volunteer entity)
        {
            ...
            {
                comm.CommandText = "insert into Volunteers (firstName,lastName,email,password) values (@firstName, @lastName, @email, @password)";
        ...
        public void Update(Volunteer entity, long id)
        {
            ...
            using (var comm = con.CreateCommand())
            {
                comm.CommandText = "update Volunteers set firstName=@firstName,lastName=@lastName,email=@email,password=@password where id=@id";
